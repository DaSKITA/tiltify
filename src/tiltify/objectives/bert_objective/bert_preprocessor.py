...
from tiltify.config import LABEL_REPLACE, RANDOM_SPLIT_SEED, Path, BASE_BERT_MODEL
...
class BERTPreprocessor(Preprocessor):
    ...
    def preprocess(self, document_collection: DocumentCollection):
        ...
        return super().preprocess(document_collection)
    ...
    def get_finetuning_datasets(
        dataset_file_path: str, bert_base_model: str, split_ratio: float = 0.33, val: bool = False,
